        ...
        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
            ...
            <div class="iq-card-body">
                <div class="col-lg-12">
                    ...
                    <p class="text-dark">Usuarios (No aplica) desde <b><span id="dateInitText"></span></b> hasta <b><span id="dateEndText"></span></b>: <b><span id="totalNoAplicaDatesText">0</span></b></p>
                </div>
