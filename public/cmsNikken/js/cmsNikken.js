        ...
        columns: [
            ...
            { 
                ...
                render: function(data, type, row){
                    ...
                    return '<a href="' + archivo + '" target="_blank" class="btn btn-success" id="getImgNewTab">Ver imagen adjunta</a><br><br><a href="javascript:void(0)" class="btn btn-success" id="getImgNewTab"><i class="ri-eye-2-line"></i> Validar documento</a>';
                },
            },
            { 
                data: 'updated_at',
